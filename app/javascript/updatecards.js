...
const technologies = {
	...
	frontend: {
		title: [ 'JavaScript (ES6)', 'HTML/CSS', 'Sass' ],
		content: [
			'Dynamic interactions with the latest JS version. Including REST APIs and Ajax calls, arrow functions, promises, event handling and more.',
